 ...
 * 输出json工厂
 */
public class JsyJsonFactory implements IJsonFactory {

    private static final JsyJsonFactory ME = new JsyJsonFactory();

    public static JsyJsonFactory me() {
        return ME;
    }
    ...
    private static class JsyJson extends Json {

        private int defaultConvertDepth = 50;
         ...
         * @return
         */
        private String underline(String param) {
